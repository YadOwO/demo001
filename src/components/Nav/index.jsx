...
export default function Nav() {
  ...
  return (
      <div className="shell" >
        <Link to="echart" className="box"><i className="iconfont icon-cangku"></i><span> 借书</span></Link>
        <Link to="bookuse" className="box"><i className="iconfont icon-liebiao"></i><span>还书</span></Link>
